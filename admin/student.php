...
// $join = "SELECT class.kelas FROM class INNER JOIN student ON class.id = student.kelas";
$join = "SELECT student.id, class.kelas, student.nis, student.name, student.alamat, student.telepon FROM student INNER JOIN class ON student.kelas = class.id";
$query = mysqli_query($connection, $join);
?>
...
<body>
  ...
  <div class="container">
    ...
    <hr />
    <a href="student/add.php" class="btn btn-primary mb-3"><i class="bi bi-plus fw-bolder fs-5 me-1"></i>Tambah Data</a>
      ...
      <tbody>
        <?php while ($result = mysqli_fetch_array($query)) : ?>
          ...
          <tr>
            ...
            <td>
              <a href=" student/edit.php?id=<?= $result["id"]; ?>" class="btn btn-success"><i class="bi bi-pencil-square"></i></a>
              <a href="student/delete.php?id=<?= $result["id"]; ?>" class="btn btn-danger"><i class="bi bi-trash"></i></a>
            </td>
          </tr>
        <?php
          $number++;
