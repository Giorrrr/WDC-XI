...
if(isset($_POST['submit'])) {
  ...
  if(checkCategory($connection, $category) == 0) {
    $update = mysqli_query($connection, "UPDATE category SET category = '$category' WHERE id_category = '$id' ");
    echo "
      <script>
...
<div class="container">
  ...
  <form method="post" action="">
    <div class="form-group mb-2">
      ...
      <input type="text" class="form-control" name="category" value="<?= $data[1]; ?>" >
      <?php if($error != '') : ?>
